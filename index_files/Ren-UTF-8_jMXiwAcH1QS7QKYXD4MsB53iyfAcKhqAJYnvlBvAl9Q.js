/*AQAAAFNIQS0yNTYAAQAAAAAAAQAAAAAAMhWDTCa76rMy09qhrf3KW1hdypJX-96vMoRT_TtnT2M*//* Script imported from https://cdn25.lemnisk.co/ssp/IN_BajajFinserv_DMP/sw/sw_registration.js */
aFeoOverrideAttrRead('script', 'src');
var notData = {};
var wlcmEnabled = 0;
var macros = {"manifest":"/manifest.json","sw":"/vendors/vizury/vizurySDKWorker.js","customOptinStatus":null,"migdomain":"bajajfinserv.in","hasMigration":true};
var __vizpush = __vizpush || {
  IframeEle: null,
  ContainerHtmlId: 'viz-push-container',
  version: '1',
  advid: 'VIZVRM5459',
  target: 'sg-pl.lemnisk.co',
  ...
  prevState: '',
  fcmMigState: '',
  vapidPublicKey: 'BPmYQTqM-CRWeYdgWJQTchavXfADf13gS42nbMqMfR3qbosei6aMaA6CgjSwVe2DW2j8Te3kj6XU221uze88P80',
  manifestLoc: macros && macros.manifest ? macros.manifest : '/manifest.json',
  swLoc: macros && macros.sw ? macros.sw : '/vizurySDKWorker.js',
  ...
  genSubscription: function(reg) {
    reg.pushManager.getSubscription().then(function(subscription) {
	 ...
	 applicationServerKey: convertedVapidKey
	    ...
	    var origin = document.URL;
            var notify = 'https://' + __vizpush.target + '/analyze/subMap?subid=' + endpoint + '&auth=' + authSecret + '&key=' + key + '&version=' + __vizpush.version + '&advid=' + __vizpush.advid + '&action=AL' +'&origin=' + origin;
            if (__vizpush.first) {
              notify = notify + '&useraction=1';
              if (wlcmEnabled) {
